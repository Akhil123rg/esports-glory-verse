...
const tournamentsData: TournamentProps[] = [
  {
    ...
    game: 'Valorant',
    gameImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1270790/header.jpg',
  ...
  },
  {
    ...
    gameImage: 'https://cdn1.epicgames.com/offer/24b9b5e323bc40eea252a10cdd3b2f10/EGS_LeagueofLegends_RiotGames_S1_2560x1440-80471666c140f790f28dff68d72c384b',
  ...
  },
  {
    ...
    gameImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/730/header.jpg',
  ...
  },
  {
    ...
    game: 'Dota 2',
    gameImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/570/header.jpg',
  ...
  },
  {
    ...
    game: 'Fortnite',
    gameImage: 'https://cdn2.unrealengine.com/social-image-chapter4-s3-3840x2160-d35912cc25ad.jpg',
  ...
  },
  {
    ...
    game: 'Rocket League',
    gameImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/252950/header.jpg',
  ...
  },
  {
    ...
    game: 'Overwatch',
    gameImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2357570/header.jpg',
  ...
  },
  {
    ...
    gameImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/359550/header.jpg',
  ...
  },
  {
    ...
    gameImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2519060/header.jpg',
